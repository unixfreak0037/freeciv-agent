...
class TestGameInfoArrayDiff:
    ...
    def test_game_info_first_packet_empty_arrays(self):
        ...
        payload = bitvector + global_advance_count + global_advances_sentinel + great_wonder_owners_sentinel
    ...
    def test_game_info_with_some_advances(self):
        ...
        payload = bitvector + global_advance_count + global_advances_diff + great_wonder_owners_sentinel
    ...
    def test_game_info_with_wonders(self):
        ...
        payload = bitvector + global_advance_count + global_advances_sentinel + great_wonder_owners_diff
    ...
    def test_game_info_delta_update(self):
        ...
        payload1 = bitvector1 + global_advance_count1 + global_advances_diff1 + great_wonder_owners_sentinel1
